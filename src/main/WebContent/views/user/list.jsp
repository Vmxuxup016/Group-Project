                    ...
                    <tbody>
                        ...
                        <tr class="table-row">
                            ...
                            <td class="text-center">
                                ...
                                <a href="${pageContext.request.contextPath}/user/delete?id=${u.id}" class="text-rose-600 hover:text-rose-800" onclick="return confirm('确定删除该用户吗？')"><i class="fas fa-trash"></i></a>
                            </td>
                        </tr>
                        </c:forEach>
