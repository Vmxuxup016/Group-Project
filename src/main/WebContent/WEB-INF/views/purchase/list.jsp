                ...
                <table class="data-table">
                    ...
                    <tbody>
                        ...
                        <tr class="table-row">
                            ...
                            <td class="text-center">
                                <a href="${pageContext.request.contextPath}/purchase/detail?id=${p.id}" class="text-blue-600 hover:text-blue-800 mr-2" title="查看"><i class="fas fa-eye"></i></a>
                                <c:if test="${p.status != 3}">
                                <a href="${pageContext.request.contextPath}/purchase/in?id=${p.id}" class="text-emerald-600 hover:text-emerald-800" title="入库"><i class="fas fa-warehouse"></i></a>
                                </c:if>
                            </td>
                        </tr>
                        </c:forEach>
