...
CREATE
DATABASE IF NOT EXISTS `asset_db`
...
-- 部门
INSERT INTO `department` (`id`, `parent_id`, `dept_name`, `dept_code`, `sort_order`)
VALUES (1, 0, '集团总部', 'GROUP', 0),
       (2, 1, '行政部', 'XZ', 1),
       (3, 1, '财务部', 'CW', 2),
       (4, 1, '技术部', 'JS', 3),
       (5, 1, '人事部', 'RS', 4),
...
INSERT INTO `user` (`id`, `username`, `password`, `real_name`, `dept_id`, `role`)
VALUES (1, 'admin', 'e10adc3949ba59abbe56e057f20f883e', '系统管理员', 1, 'admin'),
       (2, 'asset', 'e10adc3949ba59abbe56e057f20f883e', '资产管理员', 6, 'asset');

-- 资产分类
INSERT INTO `asset_category` (`id`, `parent_id`, `category_name`, `category_code`, `category_level`, `depreciable_life`,
                              `sort_order`)
VALUES (1, 0, '电子设备', 'DZ', 1, 36, 1),
       (2, 0, '办公家具', 'BG', 1, 60, 2),
...
-- 供应商
INSERT INTO `supplier` (`id`, `supplier_name`, `contact_person`, `phone`, `status`)
VALUES (1, '联想科技有限公司', '张经理', '13800138000', 1),
       (2, '华为终端有限公司', '李经理', '13900139000', 1);

-- ----------------------------
-- 资产示例数据
-- ----------------------------
INSERT INTO `asset` (`id`, `asset_code`, `asset_name`, `category_id`, `brand`, `model`, `sn_code`, `rfid_tag`,
                     ...
                     `depreciable_start_date`, `remark`)
VALUES
(1,  'DZ-JSJ-NB-001', 'ThinkPad X1 Carbon', 6, '联想', 'X1 Carbon Gen11', 'SN2024001', 'RFID001',
   'BC2024001', '2024-01-15', 12999.00, 10832.50, 1, '2027-01-15',
   2, 4, '技术部3楼A区', 36, 6, '2024-01-15', '技术部开发用笔记本'),

(2,  'DZ-JSJ-NB-002', 'ThinkPad T14s', 6, '联想', 'T14s Gen4', 'SN2024002', 'RFID002',
   'BC2024002', '2024-02-20', 8999.00, 7749.17, 1, '2027-02-20',
   2, 4, '技术部3楼B区', 36, 5, '2024-02-20', '技术部开发用笔记本'),

(3,  'DZ-JSJ-NB-003', 'MateBook X Pro', 6, '华为', 'MateBook X Pro 2024', 'SN2024003', 'RFID003',
   'BC2024003', '2024-03-10', 11999.00, 10499.17, 2, '2027-03-10',
   2, 2, '行政部2楼', 36, 4, '2024-03-10', '行政部办公用'),

(4,  'DZ-JSJ-PC-001', 'ThinkCentre M920t', 7, '联想', 'M920t', 'SN2024004', 'RFID004',
   'BC2024004', '2023-06-01', 5499.00, 3973.13, 1, '2026-06-01',
   2, 3, '财务部2楼', 36, 13, '2023-06-01', '财务部台式电脑'),

(5,  'DZ-JSJ-PC-002', 'ThinkCentre M920t', 7, '联想', 'M920t', 'SN2024005', 'RFID005',
   'BC2024005', '2023-06-01', 5499.00, 3973.13, 1, '2026-06-01',
   2, 5, '人事部2楼', 36, 13, '2023-06-01', '人事部台式电脑'),

(6,  'DZ-WL-001', '华为交换机 S5735', 4, '华为', 'S5735-L24T4S', 'SN2024006', 'RFID006',
   'BC2024006', '2023-09-15', 3680.00, 2760.00, 2, '2026-09-15',
   2, 6, '机房', 36, 10, '2023-09-15', '核心交换机'),

(7,  'DZ-WL-002', '华为路由器 AR6280', 4, '华为', 'AR6280', 'SN2024007', 'RFID007',
   'BC2024007', '2023-09-15', 8900.00, 6675.00, 2, '2026-09-15',
   2, 6, '机房', 36, 10, '2023-09-15', '出口路由器'),

(8,  'DZ-WL-003', '华为AP AP4050DN', 4, '华为', 'AP4050DN-S', 'SN2024008', 'RFID008',
   'BC2024008', '2024-01-20', 2380.00, 2082.50, 2, '2027-01-20',
   2, 6, '3楼走廊', 36, 6, '2024-01-20', '无线AP设备'),

(9,  'BG-ZY-001', '实木办公桌 1.4m', 5, '宜家', 'BEKANT', 'SN2023001', NULL,
   'BC2023001', '2023-03-01', 1299.00, 1038.20, NULL, NULL,
   2, 4, '技术部3楼', 60, 16, '2023-03-01', '技术部工位'),

(10, 'BG-ZY-002', '实木办公桌 1.4m', 5, '宜家', 'BEKANT', 'SN2023002', NULL,
   'BC2023002', '2023-03-01', 1299.00, 1038.20, NULL, NULL,
   2, 2, '行政部2楼', 60, 16, '2023-03-01', '行政部工位'),

(11, 'BG-ZY-003', '人体工学椅', 5, '西昊', 'M57', 'SN2023003', NULL,
   'BC2023003', '2023-05-10', 899.00, 734.18, NULL, NULL,
   2, 4, '技术部3楼', 60, 14, '2023-05-10', '技术部工位椅'),

(12, 'DZ-JSJ-NB-004', 'MacBook Pro 14', 6, 'Apple', 'MacBook Pro M3', 'SN2024009', 'RFID009',
   'BC2024009', '2024-04-01', 16999.00, 14639.17, NULL, '2027-04-01',
   1, NULL, '仓库A区', 36, 3, '2024-04-01', '新采购，待分配'),

(13, 'DZ-JSJ-NB-005', 'ThinkPad X1 Nano', 6, '联想', 'X1 Nano Gen3', 'SN2024010', 'RFID010',
   'BC2024010', '2024-04-01', 9999.00, 8679.17, 1, '2027-04-01',
   1, NULL, '仓库A区', 36, 3, '2024-04-01', '新采购，待分配'),

(14, 'DZ-JSJ-PC-003', 'Dell OptiPlex 7090', 7, 'Dell', '7090 MT', 'SN2024011', 'RFID011',
   'BC2024011', '2024-05-10', 6299.00, 5669.10, 1, '2027-05-10',
   3, 4, '维修中心', 36, 2, '2024-05-10', '主板故障，维修中'),

(15, 'DZ-WL-004', '海康威视监控摄像头', 4, '海康威视', 'DS-2CD2T47G2-L', 'SN2024012', 'RFID012',
   'BC2024012', '2023-12-01', 680.00, 532.78, NULL, '2026-12-01',
   2, 6, '1楼大厅', 36, 7, '2023-12-01', '安防监控'),

(16, 'BG-ZY-004', '会议桌 3.6m', 5, '宜家', 'MEETING', 'SN2023004', NULL,
   'BC2023004', '2023-01-10', 3999.00, 3065.90, NULL, NULL,
   2, 1, '集团会议室', 60, 18, '2023-01-10', '集团总部会议室'),

(17, 'DZ-JSJ-PC-004', 'iMac 24寸', 7, 'Apple', 'iMac M3 24"', 'SN2024013', 'RFID013',
   'BC2024013', '2024-06-01', 10999.00, 10265.73, 2, '2027-06-01',
   2, 3, '财务部2楼', 36, 1, '2024-06-01', '财务专用'),

(18, 'DZ-JSJ-NB-006', 'MateBook 14s', 6, '华为', 'MateBook 14s 2024', 'SN2024014', 'RFID014',
   'BC2024014', '2024-03-15', 7999.00, 7165.69, 2, '2027-03-15',
   5, NULL, NULL, 36, 4, '2024-03-15', '从技术部调往人事部，审批中'),

(19, 'DZ-JSJ-PC-005', 'ThinkCentre M920q', 7, '联想', 'M920q', 'SN2023005', 'RFID015',
   'BC2023005', '2022-06-01', 4999.00, 2499.50, 1, '2025-06-01',
   4, NULL, '报废仓库', 36, 36, '2022-06-01', '已过折旧期，待报废处理'),

(20, 'BG-ZY-005', '文件柜 钢制', 5, '震旦', 'FC-180', 'SN2023006', NULL,
   'BC2023006', '2023-04-01', 599.00, 489.18, NULL, NULL,
   2, 3, '财务部2楼', 60, 15, '2023-04-01', '财务部档案柜');
